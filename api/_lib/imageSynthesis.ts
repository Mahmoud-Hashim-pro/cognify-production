/**
 * Phase 1 / Chat Enhancement: Image Synthesis & Visual Fulfillment
 *
 * Detects visual requests (e.g. "give me an image of X", "صورة لـ X", "where is the image"),
 * extracts the core visual subject, and guarantees that real, high-quality images
 * are delivered both as embedded Markdown images and as message attachments.
 */
...
export function ensureImageInResponse(
  ...
  if (hasMarkdownImage(fullText)) {
    // Extract url from markdown if possible for attachment
